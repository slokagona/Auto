...
public class TestPriceRequest extends TestBaseClass {
	String prReqId = "PR-1569";
    @Test(priority=1)
	...
	//public void verifyDemandSetStaging(){
		//driver.findElement(
			//	By.xpath("//a[contains(text(),'  Demand Set Staging')]")).click();
	...
	public void expandUpdateDemandSet() {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Update Demand Set')]")).click();
	...
	public void createRequest() {
		...
		if (!imageValue.contains("green-accept.png")) {
			...
			if(!imageValue.contains("green-accept.png"))
			{
				Assert.fail("Image is not updated to green.");
			}
		}
